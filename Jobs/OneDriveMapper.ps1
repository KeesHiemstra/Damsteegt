...
$O365CustomerName      = "kpn1660950"              #This should be the name of your tenant (example, ogd as in ogd.onmicrosoft.com) 
...
$userLookupMode        = 6                         #1 = Active Directory UPN, 2 = Active Directory Email, 3 = Azure AD Joined Windows 10, 4 = query user for his/her login, 5 = lookup by registry key, 6 = display full form (ask for both username and login if no cached versions can be found), 7 = whoami /upn
...
$autoMapFavoritesDrvLetterList = "EFHIJKLMNOPQRSTUVXYZ" #List of driveletters that shall be used (you can ommit some of yours "reserved" letters)
